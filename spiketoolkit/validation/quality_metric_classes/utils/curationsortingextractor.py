...
class CurationSortingExtractor(SortingExtractor):
    ...
    def __init__(self, parent_sorting, previous_curation_steps=None):
        ...
        if previous_curation_steps is not None:
            assert isinstance(previous_curation_steps, list), "previous_curation_steps must be a list of previous curation commands"
            for previous_curation_step in previous_curation_steps:
                command, arguments = previous_curation_step
